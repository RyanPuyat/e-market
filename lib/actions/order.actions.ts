...
export async function createOrder() {
  try {
    ...
    //Create a transaction to create order and order items on database
...
export async function getOrderSummary() {
  ...
  >`SELECT to_char("createdAt, 'MM/YY'") as "month", sum("totalPrice") as "totalSales" FROM "Order" GROUP BY to to_char("createdAt", "MM/YY")`;
